...
public class FindArticleByIdAdminCommand implements Command {
	...
	public RouteHelper execute(HttpServletRequest request, HttpServletResponse response) {
		...
		return ArticleCommandHelper.getInstance().handleArticleByID(session, articleID, PagePath.ARTICLE_ADMIN_REDIRECT, PagePath.ARTICLE_OPERATIONS_REDIRECT, RouteMethod.REDIRECT, LOGGER);

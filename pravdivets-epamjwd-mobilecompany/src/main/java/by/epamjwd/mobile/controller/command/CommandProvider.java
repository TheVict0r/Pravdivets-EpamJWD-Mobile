...
import by.epamjwd.mobile.controller.command.impl.FindArticleByIdGuestCommand;
...
public class CommandProvider {
	...
	private CommandProvider() {
		...
		allCommands.put(CommandName.FIND_ARTICLE_BY_ID_GUEST, new FindArticleByIdGuestCommand());
		...
		allCommands.put(CommandName.FIND_PLAN_BY_ID_ADMIN, new FindPlanByIdAdminCommand());
		allCommands.put(CommandName.FIND_PLAN_BY_ID_GUEST, new FindPlanByIdGuestCommand());
		allCommands.put(CommandName.FIND_SERVICE_BY_ID_ADMIN, new FindServiceByIdAdminCommand());
		allCommands.put(CommandName.FIND_SERVICE_BY_ID_GUEST, new FindServiceByIdGuestCommand());
		allCommands.put(CommandName.FIND_NEXT_ARTICLES, new FindNextArticlesCommand());
		allCommands.put(CommandName.FIND_PREVIOUS_ARTICLES, new FindPreviousArticlesCommand());

...
import by.epamjwd.mobile.controller.command.impl.FindNextNewsCommand;
import by.epamjwd.mobile.controller.command.impl.FindPreviousNewsCommand;
...
public class CommandProvider {
	...
	private CommandProvider() {
		...
		allCommands.put(CommandName.FIND_NEXT_NEWS, new FindNextNewsCommand());
		allCommands.put(CommandName.FIND_PREVIOUS_NEWS, new FindPreviousNewsCommand());

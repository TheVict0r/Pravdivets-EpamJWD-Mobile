...
/**
 * Attribute values for HttpSession and HttpServletRequest
 *
 */
public class AttributeValue {
	...
	public static final String PLAN_EXISTS = "plan_exists";
	public static final String SERVICE_EXISTS = "service_exists";

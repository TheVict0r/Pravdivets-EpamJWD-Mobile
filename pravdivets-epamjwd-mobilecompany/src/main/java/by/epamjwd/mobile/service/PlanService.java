...
public interface PlanService {
	...
	Optional<Plan> suggestPlan(int withinNetwork, int otherNetworks, int abroad, int videocall, int sms, int mms,
			int internet) throws ServiceException;
	boolean doesPlanExist(String name) throws ServiceException;

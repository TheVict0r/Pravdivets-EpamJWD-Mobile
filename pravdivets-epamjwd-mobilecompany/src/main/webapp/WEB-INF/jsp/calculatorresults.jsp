...
<body class="d-flex flex-column min-vh-100 bg-light">
	...
	<div class="container row align-content-center col-sm-7 mx-auto flex-grow-1 gap-2">
		...
		<span class="display-3 text-center">${requestScope.best_plan.name}</span> 

		
		
		<p class="lead text-center mb-4">${best_plan.description}</p>
		...
		<table class="table table-striped">
			...
			<tbody>
				<tr>
					...
					<td>${best_plan.regularPayment/100} руб./мес.</td>
				</tr>
				<tr>
					<td>Исходящие внутри сети и на голосовую почту</td>
					<td>${best_plan.priceWithinNetwork/100} руб./мин.</td>
				</tr>
				<tr>
					<td>На стационарную сеть, сети других мобильных операторов Беларуси</td>
					<td>${best_plan.priceOtherNetworks/100} руб./мин.</td>
				</tr>
				<tr>
					<td>Международные звонки</td>
					<td>${best_plan.priceAbroad/100} руб./мин.</td>
				</tr>
				<tr>
					<td>Видеозвонки</td>
					<td>${best_plan.priceVideocall/100} руб./мин.</td>
				</tr>
				<tr>
					<td>Короткие сообщения SMS</td>
					<td>${best_plan.priceSMS/100} руб./шт.</td>
				</tr>
				<tr>
				...
				<tr>
					<td>Интернет</td>
					<td>${best_plan.priceInternet/100} руб./мб.</td>
				</tr>
			</tbody>
		</table>
	</div>

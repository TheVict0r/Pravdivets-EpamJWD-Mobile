			...
			<table>
				...
				<tr>
					...
					<td><input type="number" min="0" class="form-control"
						...
						value="${sessionScope.regular_payment}" required>
						<c:remove var="regular_payment" /></td>
				</tr>
				<tr>
					...
					<td><input type="number" min="0" class="form-control"
						...
						value="${sessionScope.upfront_payment}" required>
						<c:remove var="upfront_payment" /></td>
				</tr>
				<tr>
					...
					<td><input type="number" min="0" class="form-control"
						...
						value="${sessionScope.within_network}" required>
						<c:remove var="within_network" /></td>
				</tr>
				<tr>
					...
					<td><input type="number" min="0" class="form-control"
						...
						value="${sessionScope.other_networks}" required>
						<c:remove var="other_networks" /></td>
				</tr>
				<tr>
					<td><label for="abroad" class="form-label"><fmt:message
								key="add-plan.abroad" />:</label></td>
					<td><input type="number" min="0" class="form-control"
						name="abroad" id="abroad" 
						value="${sessionScope.abroad}" required>
				...
				<tr>
					...
					<td><input type="number" min="0" class="form-control"
						name="videocall" id="videocall" 
						value="${sessionScope.videocall}" required>
						<c:remove var="videocall" /></td>
				</tr>
				<tr>
					...
					<td><input type="number" min="0" class="form-control"
						name="sms" id="sms" 
						value="${sessionScope.sms}" required>
						<c:remove var="sms" /></td>
				</tr>
				<tr>
					...
					<td><input type="number" min="0" class="form-control"
						name="mms" id="mms" 
						value="${sessionScope.mms}" required>
						<c:remove var="mms" /></td>
				</tr>
				<tr>
					...
					<td><input type="number" min="0" class="form-control"
						...
						value="${sessionScope.internet}" required>
						<c:remove var="internet" /></td>
				</tr>
				<tr>
					<td></td>
